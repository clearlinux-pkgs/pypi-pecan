...
%prep
%setup -q -n pecan-1.4.2
cd %{_builddir}/pecan-1.4.2
pushd ..
cp -a pecan-1.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657036475
...
cp %{_builddir}/pecan-1.4.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pecan/468e4ca7bcd01061db356986e1746fb35002930d
