...
Source0  : https://files.pythonhosted.org/packages/2b/57/0eb9798962c4bf98819efca45293fb3d481ba748f1e83af165aa342cf2af/pecan-1.7.0.tar.gz
...
%prep
%setup -q -n pecan-1.7.0
cd %{_builddir}/pecan-1.7.0
pushd ..
cp -a pecan-1.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751912127
