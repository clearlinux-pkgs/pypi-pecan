...
Source0  : https://files.pythonhosted.org/packages/76/c6/e5f3cc7afef5951e03b287c58dc2f8417242f2ffad423b62db77099e9b52/pecan-1.6.0.tar.gz
...
%prep
%setup -q -n pecan-1.6.0
cd %{_builddir}/pecan-1.6.0
pushd ..
cp -a pecan-1.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742435384
